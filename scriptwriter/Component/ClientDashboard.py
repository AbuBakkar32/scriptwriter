...
class ClientDashboard(object):
    ...
    def getLatestScript(self, clientID):
        ...
        if len(listOfScript): return listOfScript
        else: return None
        # return newList
    ...
    def getAuthoredScript(self, listOfScriptIDs):
        ...
        if len(scriptList) != 0: return scriptList
        else: return None
        #return scriptList
    ...
    def getNotes(self, accountID):
        ...
        if notes.exists():
            ...
            if len(myArrayList) != 0: return myArrayList
            else: return None 
        else: return None
    ...
    def clientSettingJson(self):
        ...
        if request.method == "GET":
            ...
            elif str(user) == "<QuerySet []>": return JsonResponse({'status': 'Out off service'})
            ...
            elif str(user) == "<QuerySet []>": return JsonResponse({'result': 'failed', 'message': 'Out off service'})
