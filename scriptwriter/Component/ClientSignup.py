    ...
    def signup(self): 
        ...
        if request.method == "POST":
            ...
            if page == "registerpage":
                #save data
                fullname = replaceTOHtmlCharacter(request.POST['firstname']) +" " +replaceTOHtmlCharacter(request.POST['lastname'])
                ...
                if checkExistEmail.exists():
                    ...
                    addUp = Client(fullName = fullname, email = self.emailAddress,
                        ...
                        nightMode = False, onePageWriting = False, autoSaveTimeOut = 0,
                        waterMarkStatus = False, waterMarkDisplayText = '', waterMarkDisplayOpacity = 0,
            ...
            else: return render(request, "signup.html" ,  self.content_context)
